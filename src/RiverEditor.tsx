...
const stateLabels: Record<RiverPreviewState, string> = {
  undiscovered: 'Unentdeckt', discovered: 'Entdeckt', investigating: 'Untersuchen', echo_revealed: 'Echo', dropi_appears: 'Dropi', restored: 'Wiederhergestellt',
}
